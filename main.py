...
class Recipe:
    ...
    def show_recipe(self):
      messagebox.showinfo("Recipes:","Chia Pudding for Breakfast-INGREDIENTS & NUTRITION VALUE:1.5 tbsp chia seeds- 70cal,1/2 cup low fat milk or plant based milk- 51.2cal,Stevia to taste(can also use honey or sweetener of choice),1/4cup sweet or plain low fat curd curd (optional) - 33.7cal,1/4 cup Apple- 22cal,Pomegranate optional-Total calories 194")
